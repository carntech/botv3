...
1.  **Clone Repositori:**
    ```bash
    git clone [https://github.com/carntech/botv3.git](https://github.com/carntech/botv3.git) /root/Botv3
    cd /root/Botv3
    ```
...
| Kontak | Keterangan |
| :--- | :--- |
| **Telegram (Fast Respond)** | [![carntech](https://img.shields.io/badge/Telegram-@carntech-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/carntech) |
| **Username** | `t.me/carntech` |
